...
from src.backend.schemas.user import UserRegister
from src.backend.schemas.settings.base import ValidationError


def test_UserRegister_success(mock_UserRegister_data):
...
def test_UserRegister_fail_email_type(mock_UserRegister_data):
...
def test_UserRegister_fail_password_required(mock_UserRegister_data):
...
def test_UserRegister_fail_password_type(mock_UserRegister_data):
...
def test_UserRegister_fail_password_min_length(mock_UserRegister_data):
...
def test_UserRegister_fail_password_max_length(mock_UserRegister_data):
...
def test_UserRegister_fail_password_no_digit(mock_UserRegister_data):
...
def test_UserRegister_fail_password_no_lowercase(mock_UserRegister_data):
...
def test_UserRegister_fail_password_no_uppercase(mock_UserRegister_data):
...
def test_UserRegister_fail_password_no_especial(mock_UserRegister_data):
